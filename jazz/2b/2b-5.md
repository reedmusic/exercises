...
6. Wayne Shorter: 'Footprints'. 0:00–0:32
	...
	<details>Dorian mode. C dorian = C–D–Eb–F–G–A–Bb.
	<br>Follow-up question: In which case, which note (counting from the start) does the sax play the major 6th which separates the dorian from the aeolian?.<details>The 6th note from the start. Notice how he avoids playing this in the second chord, which is the minor submediant, since it would clash.</details>	
	</details>
