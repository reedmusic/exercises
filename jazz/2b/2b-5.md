...
6. Wayne Shorter: 'Footprints'. 0:00–0:32
	...
	<br>Follow-up question: In which case, which note (counting from the start) does the sax play the major 6th which separates the dorian from the aeolian?.<details>The 6th note from the start.</details>	
	</details>
...
8. I'm the piano player on *Kind of Blue*
	...
	<details>Wynton Kelly plays on one track but Bill Evans.</details>
